...
UCharacterHandler::UCharacterHandler()
{
	_level = 1;
...
*/
UCharacterHandler::UCharacterHandler(int level, int hp, int mAttack, int rAttack,
...
void UCharacterHandler::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UCharacterHandler::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
*/
void UCharacterHandler::DealDamage(UCharacterHandler* target, int movePower, char isMeleeAttack,
...
*/
void UCharacterHandler::TakeDamage(int oncomingDamage)
{
...
*/
void UCharacterHandler::StatChange(int statStage, int statChanged,
...
*/
void UCharacterHandler::ResetStats()
{
...
*/
void UCharacterHandler::UseMove(UAttackMoves* attackMove, UCharacterHandler* target)
{
	bool isSTAB = false;
...
*/
int UCharacterHandler::TypeCheck(UAttackMoves* move, UCharacterHandler* target)
{
	int effectiveness = 0;
...
void UCharacterHandler::AfterBattle()
{
	ResetStats();
}
...
*/
void UCharacterHandler::LevelUp(int levelsGained)
{
	_level += levelsGained;
	DetermineStats();
}
...
*/
void UCharacterHandler::StaminaRecharge(int partyMembersActive)
{
	int staminaGain;
...
*/
void UCharacterHandler::StaminaPenalty()
{
...
*/
void UCharacterHandler::DetermineStats()
{
...
*/
void UCharacterHandler::StatusCheck()
{
